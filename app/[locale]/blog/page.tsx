          ...
          <div className="divide-y divide-slate-100">
            {posts.map((post, i) => {
              ...
              return (
                ...
                >
                  <span className={`text-3xl font-black text-slate-200 transition-colors duration-200 w-10 flex-shrink-0 mt-1 select-none ${c.number}`}>
                    {num}
                  </span>
                  ...
                  <span className={`flex-shrink-0 text-xl mt-2 transition-all duration-200 opacity-0 group-hover:opacity-100 group-hover:translate-x-1 ${c.arrow}`}>
                    →
                  </span>
                </Link>
              )
