                                    ...
                                    {currentStep === 4 && (
                                        <div className="p-6 sm:p-8 space-y-6">
                                            ...
                                            <div className="space-y-3">
                                                <Label className="text-sm font-semibold text-slate-700 flex items-center gap-2"><ImageIcon className="h-4 w-4 text-slate-400" aria-label="Image description" />{t('applyParent.labels.photos')}</Label>
                                                <div onDragOver={e => { e.preventDefault(); setPhotoDragOver(true); }} onDragLeave={() => setPhotoDragOver(false)} onDrop={handlePhotoDrop}
                                                    ...
                                                    <ImageIcon className="h-8 w-8 text-slate-400 mx-auto mb-2" aria-label="Image description" />
