...
export async function generateMetadata({ params: { locale } }: Props): Promise<Metadata> {
  ...
  return {
    title: isTr ? 'Eğitim Fonlama Etki Hesaplayıcı | FundEd' : 'Education Funding Impact Calculator | FundEd',
    description: isTr
      ...
      <div className="min-h-screen flex flex-col bg-white">
        ...
        <div className="bg-white border-b border-slate-100">
          <div className="max-w-3xl mx-auto px-6 py-3 flex items-center gap-2 text-xs text-slate-400">
            ...
            <span>›</span>
            <span className="text-slate-700 font-medium">{isTr ? 'Etki Hesaplayıcı' : 'Impact Calculator'}</span>
          </div>
        </div>
