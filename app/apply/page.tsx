                    ...
                    <div className="p-6 sm:p-8 space-y-6">
                      ...
                      <div className="space-y-2">
                            ...
                            <div className="h-1.5 w-20 rounded-full bg-slate-100 overflow-hidden">
                              <div
                                className={`h-full rounded-full transition-all duration-300 ${
                                  descriptionLength >= MIN_DESCRIPTION_LENGTH ? 'bg-emerald-500' : 'bg-amber-400'
                                }`}
                        ...
                        <Textarea
                          ...
                          rows={8}
                          className={`rounded-xl border-slate-200 bg-white focus:border-purple-400 focus:ring-purple-400/20 focus:ring-4 transition-all duration-200 text-slate-800 placeholder:text-slate-300 resize-none ${
                            errors.needSummary ? 'border-red-400' : ''
                          }`}
                        />
                        {errors.needSummary && (
                          <p className="text-xs text-red-500 flex items-center gap-1">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                          ...
                          {photos.length < 5 && (
                            <div
                              ...
                              className={`aspect-[4/3] rounded-xl border-2 border-dashed flex flex-col items-center justify-center cursor-pointer transition-all duration-200 ${
                                photoDragOver
                    ...
                    <div className="p-6 sm:p-8 space-y-6">
                      ...
                      <div
                        ...
                        className={`border-2 border-dashed rounded-2xl p-8 text-center transition-all duration-300 cursor-pointer ${
                          dragOver ? 'border-emerald-400 bg-emerald-50' : 'border-slate-200 hover:border-slate-300 bg-slate-50/50'
                        }`}
